...
<head>
  ...
  <title>Admin | <?= isset($judul_halaman) ? $judul_halaman : '' ?></title>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">TEKNOSI</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          <!-- Dashboard -->
          <li class="menu-item <?= $menu_aktif == 'dashboard' ? 'active' : '' ?>">
          ...
          <!-- Cards -->
          <li class="menu-item <?= $menu_aktif == 'home' ? 'active' : '' ?>">
          ...
          <li class="menu-item">
            <a href="home_sosial_media.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              <div data-i18n="Basic">Home Sosial Media</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="about.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              <div data-i18n="Basic">About Me</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="home_sosial_media.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              <div data-i18n="Basic">My Services</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="home_sosial_media.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              <div data-i18n="Basic">My Skills</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="home_sosial_media.php" class="menu-link">
          ...
          <li class="menu-item">
            <a href="home_sosial_media.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-collection"></i>
              <div data-i18n="Basic">Contact Me</div>
            </a>
          </li>
        </ul>
      </aside>
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <span class="fw-semibold d-block"><?= $_SESSION['user']['username'] ?></span>
